...
const html2 = function (moviee) {
    ...
    <div class="movie_details_about">
        ...
        <a class="playLink" href="https://embed.smashystream.com/playere.php?tmdb=${tmdbID}"><button class="play_btn"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
